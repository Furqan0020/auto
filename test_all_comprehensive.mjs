...
console.log(`NFA Valid Pass Rate: ${nfaValidPass}/${testStrings.valid.length}\n`);
...
console.log(`NFA Invalid Pass Rate: ${nfaInvalidPass}/${testStrings.invalid.length}\n`);
...
console.log(`DFA Valid Pass Rate: ${dfaValidPass}/${testStrings.valid.length}\n`);
...
console.log(`DFA Invalid Pass Rate: ${dfaInvalidPass}/${testStrings.invalid.length}\n`);
...
console.log(`Minimized DFA Valid Pass Rate: ${minValidPass}/${testStrings.valid.length}\n`);
...
console.log(`Minimized DFA Invalid Pass Rate: ${minInvalidPass}/${testStrings.invalid.length}\n`);

console.log('=== SUMMARY ===');
console.log(`NFA:           ${nfaValidPass + nfaInvalidPass}/${testStrings.valid.length + testStrings.invalid.length} tests passed`);
console.log(`DFA:           ${dfaValidPass + dfaInvalidPass}/${testStrings.valid.length + testStrings.invalid.length} tests passed`);
console.log(`Minimized DFA: ${minValidPass + minInvalidPass}/${testStrings.valid.length + testStrings.invalid.length} tests passed`);
